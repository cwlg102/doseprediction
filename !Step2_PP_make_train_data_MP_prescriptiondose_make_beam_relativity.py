...
def MakeBeamOnehot(mr_itk, beam_basepath, beam_fol_dir,dcm_basepath, dcm_plan_dir, res_size, res_spacing,idx):
    ...
    beam_savepath = os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\traindata", "imagesTr_BEAM")
...
def GetOARdict(mr_itk, oar_basepath, oar_fol_dir, res_size, res_spacing, idx):
    ...
    oar_savepath = os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\traindata", "imagesTr_OARs")
...
def GetHPTV(mr_itk,ptv_basepath, ptv_dir, dcm_basepath, dcm_plan_dir, res_size, res_spacing, idx):
    ...
    ptv_savepath = os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\traindata", "imagesTr_HPTV")
...
def GetLPTV(mr_itk,lptv_basepath, lptv_dir, dcm_basepath, dcm_plan_dir, res_size, res_spacing, idx):
    ...
    lptv_savepath = os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\traindata", "imagesTr_LPTV")
...
def GetDose(dose_basepath, dose_dir, res_size, res_spacing, idx):
    ...
    dose_savepath = os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\traindata", "labelsTr_DOSE")
...
if __name__ == "__main__":
    ...
    for idx, mr_dir, beam_fol_dir, oar_fol_dir, hptv_dir,lptv_dir, dose_dir, dcm_plan_dir in zip(
        ...
        print('saving...')
        mr_savepath = os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\traindata", "imagesTr_MR")
