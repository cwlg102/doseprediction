...
basepath = r"X:\!project\!2025_doseprediction\data\processed_data\traindata_128_from800downsample_add_pres_chan"
...
treat_basepath = os.path.join(basepath, "imagesTr_prescription")
...
for idx in range(len(mr_dirs_list)):   
    ...
    image_list = ["./imagesTr_MR/"  + mr_dirs_list[idx],
                ...
                #   "./imagesTr_additional_info_site/" + site_dirs_list[idx],
                  "./imagesTr_prescription/" + treat_dirs_list[idx]]
