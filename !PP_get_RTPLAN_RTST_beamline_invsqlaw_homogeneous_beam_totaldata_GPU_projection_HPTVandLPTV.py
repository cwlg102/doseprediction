...
if __name__ == "__main__":
    ...
    for idx in range(100):
        ...
        sitk.WriteImage(hptv_itk, os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\HPTV", "P%03d_" %(idx) + MRN + "_hptv.nii.gz"))
        sitk.WriteImage(lptv_itk, os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\LPTV", "P%03d_" %(idx) + MRN + "_lptv.nii.gz"))
        sitk.WriteImage(mr_itk, os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\MR", "P%03d_" %(idx) + MRN + "_mr.nii.gz"))
        sitk.WriteImage(ct_itk, os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\CT", "P%03d_" %(idx) + MRN + "_ct.nii.gz"))
        
        sitk.WriteImage(dose_itk, os.path.join(r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\DOSE", "P%03d_" %(idx) + MRN + "_dose.nii.gz"))
        
        BEAM_SAVEPATH = r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\BEAM"
        os.makedirs(os.path.join(BEAM_SAVEPATH, "P%03d_" %(idx) + MRN), exist_ok=True)
        OAR_SAVEPATH = r"X:\!project\!2025_doseprediction\data\processed_data\raw_data\OAR"
