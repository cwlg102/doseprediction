...
basepath = r"X:\!project\!2025_doseprediction\data\processed_data\traindata_128_from800downsample_add_pres_chan_ts"
...
pres_basepath = os.path.join(basepath, "imagesTr_prescription")
pres_dirs_list = os.listdir(pres_basepath)

treat_basepath = os.path.join(basepath, "imagesTr_additional_info_treatment")
treat_dirs_list = os.listdir(treat_basepath)
site_basepath = os.path.join(basepath, "imagesTr_additional_info_site")
site_dirs_list = os.listdir(site_basepath)
...
for idx in range(len(mr_dirs_list)):   
    ...
    image_list = ["./imagesTr_MR/"  + mr_dirs_list[idx],
                  ...
                  "./imagesTr_prescription/" + pres_dirs_list[idx]]
    
    
    for key in oar_name_dict.keys():
        image_list.append("./imagesTr_OARs/" + pnum + "_" + key + ".nii.gz")
    image_list.append("./imagesTr_additional_info_treatment/" + treat_dirs_list[idx])
    image_list.append("./imagesTr_additional_info_site/" + site_dirs_list[idx])
...
for idx in range(len(mr_dirs_list)):   
    ...
    image_list = ["./imagesTr_MR/"  + mr_dirs_list[idx],
                  ...
                  "./imagesTr_HPTV/" + hptv_dirs_list[idx],
                  "./imagesTr_LPTV/" + lptv_dirs_list[idx],
                #   "./imagesTr_additional_info_site/" + site_dirs_list[idx],
                  "./imagesTr_prescription/" + pres_dirs_list[idx]]
    for key in oar_name_dict.keys():
        image_list.append("./imagesTr_OARs/" + pnum + "_" + key + ".nii.gz")
    image_list.append("./imagesTr_additional_info_treatment/" + treat_dirs_list[idx])
